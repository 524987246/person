...
import org.great.util.RRException;
import org.great.web.jdbc.ColumnEntity;
import org.great.web.jdbc.TableEntity;
...
//		map.put("datetime",
//				DateUtil.format(new Date(), DateUtil.DATE_TIME_PATTERN));
...
//						getFileName(template, tableEntity.getClassName(),
