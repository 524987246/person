var urlArray = {
	add_edit_url : ProjectUrl("Reception/buz/linkman/one.html"),
	list_url : ProjectUrl("Reception/buz/linkman/list.html"),
	del_url : ProjectUrl("Reception/buz/linkman/del.html"),
	batch_del_url : ProjectUrl("Reception/buz/linkman/batchdelete.html")
}
var columnsArray = [
	{
		data : null,
		...
		"ajax" : function(data, callback, settings) {
			...
			$.ajax({
				...
				success : function(data) {
					...
					returnData.recordsTotal = data.object.buzLinkman.totalCount; //返回数据全部记录
					returnData.recordsFiltered = data.object.buzLinkman.totalCount; //后台不实现过滤功能，每次查询均视作全部结果
