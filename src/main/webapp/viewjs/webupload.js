jQuery(function() {  
    ...
    {    
        ...
        afterSendFile:function(){  
            ...
            $.ajax({    
                type:"POST",    
                url:basePath+"/Reception/mergeFile.html",  //ajax将所有片段合并成整体  
                data:{    
                    fileName : fileName,  
                    fileMd5:fileMd5,  
                },    
    ...
    uploader = WebUploader.create({  
        ...
        swf: basePath+'statis/webupload/Uploader.swf',// swf文件路径    
        server: basePath+"/Reception/uoloadFile.html",// 文件接收服务端  
    ...
    uploader.on('fileQueued', function(file) {  
        ...
        $.ajax({    
            type:"POST",    
            url:basePath+"/Reception/selectProgressByFileName.html",  //先检查该文件是否上传过，如果上传过，上传进度是多少  
            data:{    
    ...
    $btn.on('click', function(){  
        if (state === 'uploading'){  
            ...
            $.ajax({    
                type:"POST",    
                url:basePath+"/Reception/selectProgressByFileName.html",    
                data:{    
