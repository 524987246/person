var urlArray = {
	add_edit_url : ProjectUrl("Reception/sys/role/one.html"),
	list_url : ProjectUrl("Reception/sys/role/list.html"),
	del_url : ProjectUrl("Reception/sys/role/del.html"),
	batch_del_url : ProjectUrl("Reception/sys/role/batchdelete.html")
}
var columnsArray = [
	{
		data : null,
