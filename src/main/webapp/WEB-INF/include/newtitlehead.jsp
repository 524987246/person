...
<script type="text/javascript" src="${ctx}/statis/ueditor/ueditor.all.min.js"> </script> 
<script type="text/javascript" src="${ctx}/statis/ueditor/lang/zh-cn/zh-cn.js"></script>
<!-- 富文本编辑器  结束 -->
