...
<!--请在下方写此页面业务相关的脚本-->
<script type="text/javascript" src="${ctx}/statis/newjsp/lib/jquery.validation/1.14.0/jquery.validate.js"></script> 
<script type="text/javascript" src="${ctx}/statis/newjsp/lib/jquery.validation/1.14.0/validate-methods.js"></script> 
<script type="text/javascript" src="${ctx}/statis/newjsp/lib/jquery.validation/1.14.0/messages_zh.js"></script>
<script type="text/javascript" src="${ctx}/statis/newjsp/lib/webuploader/0.1.5/webuploader.min.js"></script> 
