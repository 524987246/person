...
<body>
	...
	<div class="page-container">
		<div class="text-c">
			...
			<input type="text" name="name" id="name" placeholder="用户名称"
		...
		<div class="cl pd-5 bg-1 bk-gray mt-20">
			<span class="l"> <shiro:hasPermission name="sys:role:save">
					<a class="btn btn-primary radius" data-title="添加角色"
						data-href="${ctx }/Reception/sys/role/one.html"
	...
	<script type="text/javascript" src="${ctx}/viewjs/sys/role-list.js"></script>
</body>
</html>